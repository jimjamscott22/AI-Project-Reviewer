...
// Ported from frontend/src/data/sampleData.ts (APR_SAMPLE) — same five repos,
// same shape, so seeding this into MariaDB and reading it back through
// GET /api/repos round-trips to the exact JSON the frontend already renders.
// `ageMs` replaces the prototype's static "2 hours ago" strings: the seed
// script sets reviews.generated_at to now - ageMs, and the API recomputes the
// relative-time string at read time.
export const SEED_REPOS: (Repo & { ageMs: number })[] = [
  {
    ...
    quality: {
      metrics: [['Lint issues', '23'], ['Complexity', 'B'], ['Duplication', '4%'], ['Type hints', '61%']],
  ...
  },
  {
    ...
    quality: {
      metrics: [['Lint issues', '4'], ['Complexity', 'A'], ['Duplication', '2%'], ['Type coverage', '96%']],
  ...
  },
  {
    ...
    quality: {
      metrics: [['Lint issues', '41'], ['Complexity', 'C'], ['Duplication', '7%'], ['JSDoc coverage', '22%']],
  ...
  },
  {
    ...
    quality: {
      metrics: [['Lint issues', '88'], ['Complexity', 'D'], ['Duplication', '11%'], ['Docstrings', '18%']],
  ...
  },
  {
    ...
    quality: {
      metrics: [['Lint issues', '7'], ['Complexity', 'A'], ['Duplication', '9%'], ['Type coverage', '88%']],
