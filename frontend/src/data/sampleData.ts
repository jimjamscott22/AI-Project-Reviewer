...
// Ported from the design-handoff prototype's reviewer-data.js (window.APR_SAMPLE).
// Canonical joined shape the frontend expects: one record per repo with its latest review.
export const APR_SAMPLE: Repo[] = [
  {
